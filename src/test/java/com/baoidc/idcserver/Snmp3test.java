...
public class Snmp3test {
	    public static void main(String[] args) throws IOException, InterruptedException {  
	        ...
	        UsmUser user = new UsmUser(  
	                new OctetString("jiang"),  
	                AuthMD5.ID, new OctetString("jiang123456"),  
	                PrivDES.ID, new OctetString("jiang123456"));
	        ...
	        snmp.getUSM().addUser(new OctetString("jiang"), user);  
	          
	        UserTarget target = new UserTarget();  
	        target.setVersion(SnmpConstants.version3);  
	        target.setAddress(new UdpAddress("192.168.7.111/161"));  
	        target.setSecurityLevel(SecurityLevel.AUTH_PRIV);  
	        target.setSecurityName(new OctetString("jiang"));  
